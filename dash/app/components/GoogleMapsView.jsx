...
const GoogleMapsView = ({ placeList }) => {
  ...
  const fetchDirections = async (
    ...
    try {
      const url = `https://maps.googleapis.com/maps/api/directions/json?origin=${startLat},${startLng}&destination=${destinationLat},${destinationLng}&key=AIzaSyAzUPTOODmdD55JHmx-1IN4GcLP6qAb_bk`
